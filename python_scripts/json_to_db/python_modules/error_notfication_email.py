...
def send_email(error_log: str = ""):
    ...
    email_password = "your_email_password_here"  # if it's gmail, you will need a password app. See more in https://support.google.com/accounts/answer/185833?hl=en
    email_receiver = "the_reciver_email_here"
